...
namespace Kit
{
	...
	public:
		font_cache(string _font_name, font_style _font_style, font_weight _font_weight, string _path);
	...
	public:
		font_find(string font_name, font_style font_style, font_weight font_weight);
